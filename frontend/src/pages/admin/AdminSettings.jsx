                ...
                <Card className="p-8 border-slate-200 shadow-sm transition-all">
                    ...
                    <form onSubmit={handlePasswordSubmit} className="space-y-6">
                        ...
                        <div className="pt-4 flex justify-end">
                            <button type="submit" disabled={passLoading} className="bg-slate-900 hover:bg-slate-800 text-white font-bold py-3 px-6 rounded-xl flex items-center gap-2 transition-all active:scale-95 disabled:opacity-50">
